		...
		<div class="col-md-12" style="border: 1px solid red;">
			  <c:forEach items="${prodlist}" var="i">
			   <div class="col-md-12" style="margin-top:2%;  background-color:#F8F8F8;">
			   		<div class="col-md-12">
			   				<div  style="float:left; "><img src="<c:url value="/resource/images/product/${i.product_image}" /> " width="300px" ></div>
			   		  ...
			   		  <div class="btnDiv">
			   		  			 <a href="addCart" class="btn btn-info" style="text-decoration:none;">Add To Cart</a> <br/>
			   		   			 <a href="#"  class="btn btn-info" style="margin-top:10%;">Description</a>
